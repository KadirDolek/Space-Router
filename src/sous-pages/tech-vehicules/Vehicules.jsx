      ...
      >
        ...
        <div style={{ display: "flex", flexWrap: "wrap", marginRight: "30px" }}>
          ...
          >
            ...
            <p style={{ fontSize: "60px" }}>Launch Vehicule</p>A launch vehicle
            or carrier rocket is a rocket-propelled vehicle used to carry a
            payload from Earth's surface to space, usually to Earth orbit or
